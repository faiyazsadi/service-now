...
class Accept extends StatefulWidget {
  ...
  const Accept({super.key, required this.myLatitude, required this.myLongitude, required this.userLatitude, required this.userLongitude, required this.changedScreen});
  @override
...
class _AcceptState extends State<Accept> {
  ...
  void getUserInfo() async {
    ...
    final user_phone_no_snap = await uRef.child("password").get();

    usr_name = user_name_snap.value.toString();
    user_phone_no = user_phone_no_snap.value.toString();
